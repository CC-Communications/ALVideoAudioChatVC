...
+ (ALAudioVideoCallVC*) createAudioVideoController {
    UIStoryboard* storyboard = [UIStoryboard storyboardWithName:@"AudioVideo" bundle:[NSBundle bundleForClass:[self class]]];
    ALAudioVideoCallVC* controller = (ALAudioVideoCallVC*)[storyboard instantiateViewControllerWithIdentifier:@"ALAudioVideoCallVC"];
    return controller;
}
